...
router.get('/:tipo', middleware, (req, res) => {
    ...
    let query;
    if (tipo == 0) {
        query = `SELECT r.id, r.descripcion, r.latitud, r.longitud, r.positivos, r.negativos, r.emergencia, u.id as idUsuario, concat_ws(' ', nombre, apellidoPaterno, apellidoMaterno) as nombreUsuario, 
